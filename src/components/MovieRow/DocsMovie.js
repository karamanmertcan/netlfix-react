...
const DocsMovie = ({ docs, imgPath, trailerUrl, opts, handleClick }) => {
    ...
    <>
      ...
      <div className='flex  mx-auto h-72 w-full transition duration-500 ease-in-out space-x-1'>
        <button
          ...
          className='flex flex-start action   w-48 items-center focus:outline-none text-white bg-gray-800 transform scale-100 hover:scale-110 transition duration-500 ease-in-out'
        >
          <ChevronLeft />
        </button>
